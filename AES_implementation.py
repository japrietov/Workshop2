...
tmp1 = add_round_key(make_state_message(message_test), key_generator(key_test)[0])

tmp2 = subbytes_matrix_convert(tmp1)

print shift_row(tmp2)

# print hex(int(format(55, '02x'),16)^int(format(25, '02x'),16))
